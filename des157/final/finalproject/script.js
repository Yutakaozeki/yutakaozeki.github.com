(function() {
    ...
    close[2].addEventListener('click', function(event) {
        event.preventDefault();
    ...
    close[3].addEventListener('click', function(event) {
        event.preventDefault();
    ...
    close[4].addEventListener('click', function(event) {
        event.preventDefault();
    ...
    close[5].addEventListener('click', function(event) {
        event.preventDefault();
    ...
    close[6].addEventListener('click', function(event) {
        event.preventDefault();
